    ...
    },
    {
      title: (
        <div className="flex items-center gap-x-2">
          ...
          <span>{isTypeScript ? "Alert.tsx" : "Alert.js"}</span>
        </div>
      ),
      content: (
        <SyntaxHighlighter
    ...
    },
    {
      ...
      content: (
        <SyntaxHighlighter
          ...
          wrapLines={true}
        >
          {isTypeScript ? alertPreviewCodeTS : alertPreviewCodeJS}
        </SyntaxHighlighter>
      ),
      contentToCopy: isTypeScript ? alertPreviewCodeTS : alertPreviewCodeJS,
    },
  ];
  return (
    <>
