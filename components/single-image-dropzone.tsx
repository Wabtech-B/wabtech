...
const variants = {
  base: "relative rounded-md flex justify-center items-center flex-col cursor-pointer min-h-[100px] w-full border border-dashed border-border transition-colors duration-200 ease-in-out",
  image:
