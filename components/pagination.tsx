    ...
    <ul className="flex items-center space-x-2">
      <li>
        <button
          ...
          className={`px-2 rounded-lg border hover:bg-accent/80 h-8 disabled:opacity-50 disabled:cursor-not-allowed ${
            ...
            <li key={index}>
              {page === null ? (
                ...
                <button
                  ...
                  className={`w-8 h-8 grid place-items-center rounded-lg border hover:bg-accent/80 ${
                    className || ""
